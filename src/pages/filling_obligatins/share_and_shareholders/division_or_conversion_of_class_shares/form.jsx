...
class DivisionOrConversionOfClassSharesForm extends Form {
    state = {  
        activeStep: 0,
        data1: {
            name_of_company: '',
    ...
    schema2 = {
        ...
        date_of_subDivision: Joi.allow('').label("This field"),
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Division or Conversion of a Class Of Shares $99</SelctText>
                        ...
                        {this.state.activeStep === 1 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={6}>
                                        {this.renderSelect("service", "Select service",this.service, 'true')}
                                    </Grid>
                                    <Grid item xs={6}>
                                    ...
                                    <Grid item xs={6}>
                                        {this.renderInput("date_of_subDivision", "Date of Consolidation/ sub-division ", 'date')}
                                    </Grid>
                                    <Grid item xs={6}>
...
export default DivisionOrConversionOfClassSharesForm;