...
class CompanyNameReservationform extends Form {
    state = {  
        activeStep: 0,
        data1: {
            is_identical: '',
    ...
    schema1 = {
        ...
        service: Joi.allow().label("This field"),
    ...
    service = [
        { value: '410H ~ Application to reserve a name (new company)', label: '410H ~ Application to reserve a name (new company) ' },
        { value: '410K ~ Application to reserve a name (existing company)', label: '410K ~ Application to reserve a name (existing company) ' },
    ];
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Application for Reservation of Company Name $119</SelctText>
                        ...
                        {this.state.activeStep === 0 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={12}>
                                        {this.renderSelect("service", "Select service",this.service)}
                                    </Grid>
                                   {data1.service.value === '410K ~ Application to reserve a name (existing company)' ?
                                        <>
                                            <Grid item xs={12}>
                                                {this.renderInput("name_of_company", "Name of company ", 'text')}
                                            </Grid>
                                            <Grid item xs={12}>
