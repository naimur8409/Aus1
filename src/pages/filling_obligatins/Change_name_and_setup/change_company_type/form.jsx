...
class CompanySetupform extends Form {
    state = {  
        activeStep: 0,
        data1: {
            name_of_company: '',
    ...
    schema2 = {
        ...
        proposed_company_type: Joi.allow('').label("This field"),
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Change of company type $499</SelctText>
                        ...
                        {this.state.activeStep === 1 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={6}>
                                        {this.renderSelect("proposed_company_type", "Insert the proposed types of the company ? ",this.company_type)}
                                    </Grid>
                                    <Grid item xs={6}>
