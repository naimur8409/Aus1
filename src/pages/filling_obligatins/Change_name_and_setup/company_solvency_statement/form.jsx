...
class CompanySolvencyStatementForm extends Form {
    state = {  
        activeStep: 0,
        data1: {
            name_of_company: '',
    ...
    schema2 = {
        solvency_status: Joi.allow().label("This field"),
                        ...
                        {this.state.activeStep === 1 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={12}>
                                        {this.renderSelect("solvency_status", "Name of company ", this.solvency_status, 'true')}
                                    </Grid>
                                    {data2.solvency_status.value === 'Negative solvency resolution passed' ?
                                        <Grid item xs={12}>
                                            {this.renderInput("date_of_resolution", "Solvency resolution not passed", 'date')}
                                        </Grid>
                                        :null 
                                    }
                                    {data2.solvency_status.value === 'Solvency resolution not passed' ?
                                        <Grid item xs={12}>
                                            {this.renderInput("date_of_review", "Provide company review date", 'date')}
                                        </Grid>
                                        :null 
                                    }
...
export default CompanySolvencyStatementForm;