...
class NameChangeOfOfficeholderform extends Form {
    state = {  
        activeStep: 0,
        data1: {
            name_of_company: '',
    ...
    schema2 = {
        whose_name: Joi.allow('').label("This field"),
        person_for_alternate: Joi.allow('').label("This field"),
        previous_given_name: Joi.allow('').label("This field"),
        previous_family_name: Joi.allow('').label("This field"),
                        ...
                        {this.state.activeStep === 1 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={6}>
                                        {this.renderSelect("whose_name", "Who’s name do you want to change?",this.role)}
                                        {data2.whose_name.value === 'Alternate director' ?
                                    ...
                                    <Grid item xs={6}>
                                        {this.renderInput("previous_given_name", "Given name", 'text')}
                                    </Grid>
                                    <Grid item xs={6}>
                                        {this.renderInput("previous_family_name", "Family name", 'text')}
                                    </Grid>
                                    <Grid item xs={6}>
...
export default NameChangeOfOfficeholderform;