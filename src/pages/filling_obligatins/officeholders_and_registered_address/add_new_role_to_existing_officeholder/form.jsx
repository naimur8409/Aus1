...
class AddNewRoleToOfficeholderform extends Form {
    state = {  
        activeStep: 0,
        data1: {
            name_of_company: '',
    ...
    schema2 = {
        role_of_officeholder: Joi.allow('').label("This field"),
        person_for_alternate: Joi.allow('').label("This field"),
        new_role_of_officeholder: Joi.allow('').label("This field"),
        new_person_for_alternate: Joi.allow('').label("This field"),
        given_name_of_officeholder: Joi.allow('').label("This field"),
        family_name_of_officeholder: Joi.allow('').label("This field"),
        ...
        date_of_new_role: Joi.allow('').label("This field"),
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Add new role to existing officeholder $39</SelctText>
                    ...
                    <form style={{width: '100%'}} >
                        ...
                        {this.state.activeStep === 1 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    <Grid item xs={12}>
                                        <h5>Add new role to existing officeholder</h5>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <p>Name of existing officeholder</p>
                                    </Grid>
                                    <Grid item xs={6}>
                                        {this.renderInput("given_name_of_officeholder", "Given name", 'text', 'true')}
                                    </Grid>
                                    <Grid item xs={6}>
                                        {this.renderInput("family_name_of_officeholder", "Family name", 'text')}
                                    </Grid>
                                    <Grid item xs={12}>
                                        <p>Address of the existing officeholder</p>
                                    </Grid>
                                    <Grid item xs={4}>
                                    ...
                                    <Grid item xs={12}>
                                        {this.renderSelect("role_of_officeholder", "Role of the existing officeholder",this.role)}
                                        {data2.role_of_officeholder.value === 'Alternate director' ?
                                        
                                            this.renderInput("person_for_alternate", "Person alternate for", 'text')
                                       
                                        :null
                                    }
                                    </Grid>
                                    <Grid item xs={12}>
                                        {this.renderSelect("new_role_of_officeholder", "New role",this.role)}
                                        {data2.new_role_of_officeholder.value === 'Alternate director' ?
                                        
                                            this.renderInput("new_person_for_alternate", "Person alternate for", 'text')
                                    ...
                                    <Grid item xs={12}>
                                        {this.renderInput("date_of_new_role", "Enter appointment dates for new role", 'date')}
                                    </Grid>
                                    <Grid item xs={12}>
                                        {this.renderTextArea("describe", "Please describe the terms of appointment ")}
                                    </Grid>
...
export default AddNewRoleToOfficeholderform;