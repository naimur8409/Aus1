...
class CeaseOfficeholderform extends Form {
    state = {  
        activeStep: 0,
        data1: {
            name_of_company: '',
        ...
        data2: {
            ...
            officeholder_given_name: '',
            officeholder_family_name: '',
            date_of_birth: '',
            country_of_birth: '',
            town_of_birth: '',
            given_name: '',
    ...
    schema2 = {
        ...
        officeholder_given_name: Joi.allow('').label("This field"),
        officeholder_family_name: Joi.allow('').label("This field"),
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Change of Name: Officeholder or Member $39</SelctText>
                    ...
                    <form style={{width: '100%'}} >
                        ...
                        {this.state.activeStep === 1 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    <Grid item xs={12}>
                                        <h5>Terminate/cease Officeholder</h5>
                                    </Grid>
                                    <Grid item xs={12}>
                                        {this.renderSelect("role_of_officeholder", "Role of the ceased officeholder",this.role, 'true')}
                                    ...
                                    <Grid item xs={12}>
                                        <p>Name of the ceased officeholder </p>
                                    </Grid>
                                    <Grid item xs={6}>
                                        {this.renderInput("officeholder_given_name", "Given name", 'text')}
                                    </Grid>
                                    <Grid item xs={6}>
                                        {this.renderInput("officeholder_family_name", "Family name", 'text')}
                                    </Grid>
                                    <Grid item xs={6}>
                                    ...
                                    <Grid item xs={12}>
                                        {this.renderInput("date_of_cessation", "Date of cessation/termination", 'date')}
                                    </Grid>
...
export default CeaseOfficeholderform;