...
class AppointmentOfAlternateDirectorForm extends Form {
    state = {  
        activeStep: 0,
        data1: {
            name_of_company: '',
    ...
    schema2 = {
        ...
        when_end: Joi.allow('').label("This field"),
        is_for_specific_time: Joi.allow('').label("This field"),
        conditions: Joi.allow('').label("This field"),
    };
    schema3 = {
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Appointment of An Alternate Director $49</SelctText>
                        ...
                        {this.state.activeStep === 1 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={12}>
                                        <p>Name of the alternate director</p>
                                    </Grid>
                                    <Grid item xs={6}>
                                    ...
                                    <Grid item xs={12}>
                                        {this.renderInput("date_of_appointment", "Date of appointment", 'date')}
                                    </Grid>
                                    <Grid item xs={6}>
                                        {this.renderSelect("is_for_specific_time", "Is the appointment for specific time?",this.common)}
                                    </Grid>
                                    {data2.is_for_specific_time.value === 'Yes' ?
                                        <Grid item xs={6}>
                                            {this.renderInput("when_end", "When does it end?", 'date')}
                                        </Grid>
                                        :null
                                    }
                                    <Grid item xs={12}>
                                        {this.renderTextArea("conditions", "Provide the conditions of appointment ")}
                                    </Grid>
...
export default AppointmentOfAlternateDirectorForm;