...
class AppointmentOfNewDirectorForm extends Form {
    state = {  
        activeStep: 0,
        data1: {
            name_of_company: '',
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Appointment of A New Director $39</SelctText>
                        ...
                        {this.state.activeStep === 1 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={6}>
                                        {this.renderInput("given_name_of_director", "Given name", 'text')}
                                    </Grid>
                                    <Grid item xs={6}>
                                    ...
                                    <Grid item xs={12}>
                                        <p>Residential address of the director</p>
                                    </Grid>
                                    <Grid item xs={4}>
...
export default AppointmentOfNewDirectorForm;