...
class AppointmentOfNewOfficeholderform extends Form {
    state = {  
        activeStep: 0,
        data1: {
            name_of_company: '',
    ...
    schema2 = {
        date_of_appointment: Joi.allow().label("This field"),
        ...
        has_former: Joi.allow('').label("This field"),
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Appointment of new officeholder $39</SelctText>
                    ...
                    <form style={{width: '100%'}} >
                        ...
                        {this.state.activeStep === 1 ?
                            <FormContainer>
                                <Grid container spacing={1}>
                                    <Grid item xs={12}>
                                        <h5>Officeholder Details</h5>
                                    </Grid>
                                    <Grid item xs={6}>
                                        {this.renderInput("date_of_appointment", "Date of appointment", 'date','true')}
                                    </Grid>
                                    <Grid item xs={6}>
                                        {this.renderSelect("role_of_officeholder", "Role of appointed officeholder",this.role)}
                                    ...
                                    <Grid item xs={12}>
                                        <p>Name of officeholder</p>
                                    </Grid>
                                    <Grid item xs={6}>
                                        {this.renderInput("given_name_of_officeholder", "Given name", 'text')}
                                    </Grid>
                                    <Grid item xs={6}>
                                    ...
                                    <Grid item xs={12}>
                                        {this.renderSelect("has_former", "Does this person have any former names?",this.common)}
                                    </Grid>
                                    {data2.has_former.value === 'Yes' ?
                                        <>
                                            <Grid item xs={12}>
                                                <p>Provide the former name</p>
                                            </Grid>
                                            <Grid item xs={6}>
                                    ...
                                    <Grid item xs={12}>
                                        <p>Residential address of the new officeholder</p>
                                    </Grid>
                                    <Grid item xs={4}>
...
export default AppointmentOfNewOfficeholderform;