...
import PAYGReview from './paygReview';
import PAYGBilling from './paygBilling';
...
class PAYGRegForm extends Form {
    ...
    // console.log(this.state.errors)
        return ( 
            ...
            <SelctText>PAYG registration $39</SelctText>
                ...
                <form style={{width: '100%'}} >
                    ...
                    {this.state.activeStep === 3 ?
                        <PAYGReview data1={data1} data2={data2} data3={data3} fnc1={this.handleNext} fnc2={this.handleBack} />
                   : null}

                    {this.state.activeStep === 4 ?
                     <PAYGBilling fnc1={this.handleNext} fnc2={this.handleBack} fnc3={this.handleReset} />
                    : null
                    }
                </form>
