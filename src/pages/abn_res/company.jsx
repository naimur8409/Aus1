...
class Company extends Component {
     ...
     handleNext = () => {
      ...
      handleChange = (e) => {
        ...
        if(e.target.name === 'number_of_directors'){
            ...
            let prev = this.state.data.number_of_directors;
            let obj =   {
                    former: '',
                    given_name: '',
                    family_name:'',
    ...
    render() { 
        ...
        let value = [];
            ...
            // let element = [] ;
        for(let i = 1 ; i <= data.number_of_directors ; i++){
            value.push(
                <>
                    {/* <Grid item xs={12} > */}
                    <p style={{width: '100%', padding: '5px',color: '#fff', backgroundColor: '#3389FF'}}>Director {i}</p>
                    {/* </Grid> */}
        ...
        return ( 
            <Container status = {this.props.status}> 
                <SelctText>YOU HAVE SELECTED COMPANY CATEGORY</SelctText>
                {/* <Line>&nbsp;sdfds</Line> */}
                ...
                <form action="">
                    {this.state.activeStep === 0 ?
                        <FormContainer>
                            <h3>Please provide details of all directors</h3>
                            <Grid container spacing={1}>
                                <Grid item xs={12}>
                                    <TextInput label="ACN No" type="text" name="acn_no" value={data.acn_no} placeholder="ACN No" onChange={(e) => this.handleChange(e)} />
                                </Grid>

                                <Grid item xs={12}>
                                    <p>Is the company a majority-owned subsidiary? </p>
                                    <RadioInput label="Yes" value="yes" name="subsidiary" checked={data.subsidiary === "yes"} onChange={(e) => this.handleChange(e)}  />
                                    <RadioInput label="No" value="no" name="subsidiary" checked={data.subsidiary === "no"} onChange={(e) => this.handleChange(e)}  />
                                    
                                </Grid>

                                {data.subsidiary === 'yes' ?
                                    <Grid item xs={12}>
                                        <TextInput label="Please provide the holding company’s ACN" type="text" name="companys_ACN"  value={data.companys_ACN} placeholder="Company’s ACN" onChange={(e) => this.handleChange(e)} />
                                    </Grid>
                                    : null}

                                <Grid item xs={12}>
                                    <TextInput label="Number of Directors" type="number" name="number_of_directors" min="1" max="10" value={data.number_of_directors} placeholder="Number of Directors" onChange={(e) => this.handleChange(e)} />
                                </Grid>
                               {/* {this.makeForm(data)} */}
                               {value}
