...
const Review = ({data1, fnc1, fnc2,fnc3}) => {
    return ( 
             <PreviewContainer style={{width: '100%' , backgroundColor: 'rgba(51, 136, 255, 0.5)'}}>
                        ...
                        <Grid container spacing={1}>
                         ...
                         <Grid item xs={12}>
                             ...
                             <p>Confidentiality Policy : <strong>{data1.person} </strong></p>
                             
                         </Grid>
                         <Grid item xs={12}>
                             <h3 style={{textAlign: 'left'}}>Select your product</h3> <hr/>
                             <p>Product Name : <strong>{data1.product} </strong></p>
                             
                         </Grid>
                         <Grid item xs={12}>
                             <h3 style={{textAlign: 'left'}}>Service speed</h3> <hr/>
                             <p>speed: <strong>{data1.Sspreed} </strong></p>
                             
                         </Grid>
                         <Grid item xs={12}>
                             <h3 style={{textAlign: 'left'}}>Select your jurisdiction</h3> <hr/>
                             <p>jurisdiction : <strong>{data1.Sjurisdiction } </strong></p>
