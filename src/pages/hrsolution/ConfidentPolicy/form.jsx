...
class ConfidentialityPolicyForm extends Form {
    state = {  
        activeStep: 0,
        data1: {
            person: '',
    ...
    schema1 = {
        person: Joi.string().allow().label("This field"),
    ...
    pname = [
        { value: 'Standard Policy $79', label: 'Standard Policy $79' },
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Confidentiality Policy $79 </SelctText>
                        ...
                        {this.state.activeStep === 0 ?
                            <FormContainer>
                                ...
                                <Grid container spacing={1}>
                                    <Grid item xs={12}>
                                        {this.renderInput("person", "What is the name of the person and position to contact if there are any questions regarding this Confidentiality Policy? ", 'text', 'true')}
                                    </Grid>
                                    <Grid item xs={12}>
...
export default ConfidentialityPolicyForm;