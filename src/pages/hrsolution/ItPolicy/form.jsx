...
class ItpolicyFrom extends Form {
    state = {  
        activeStep: 0,
        data1: {
            regarding:'',
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>IT Policy $89</SelctText>
                    ...
                    <form style={{width: '100%'}} >
                        {this.state.activeStep === 0 ?
                            <FormContainer>
                                ...
                                <Grid item xs={12}>
                                        {this.renderInput("regarding", "Who should be contacted if there are any questions regarding the IT Use Policy? ", 'text')}
                                    </Grid>
                                    <Grid item xs={12}>
                                        {this.renderInput("responsible", "What is the title of the individual responsible for the IT Use Policy? ", 'text')}
                                    </Grid>
                                    <Grid item xs={12}>
