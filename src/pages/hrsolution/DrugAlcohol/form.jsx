...
class DrugAlcoholPoliciyfrom extends Form {
    state = {  
        activeStep: 0,
        data1: {
            person: '',
    ...
    render() { 
        ...
        return ( 
            <RegistrationContainer>
                <FormWrapper>
                    <SelctText>Drug & Alcohol Policy $79 </SelctText>
                        ...
                        {this.state.activeStep === 0 ?
                            <FormContainer>
                                ...
                                <Grid container spacing={1}>
                                    <Grid item xs={12}>
                                        {this.renderInput("person", "What is the name and position of the person to contact if there are any questions regarding this Drugs & Alcohol Policy? ", 'text')}
                                    </Grid>
                                    <Grid item xs={12}>
...
export default DrugAlcoholPoliciyfrom;