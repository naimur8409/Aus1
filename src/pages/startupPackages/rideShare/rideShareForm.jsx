...
import RideBilling from './rideBilling';
...
class RideShareRegForm extends Form {
    ...
    // console.log(this.state.errors)
        return ( 
            ...
            <SelctText>Ride-Share Business Package $69</SelctText>
                ...
                <form style={{width: '100%'}} >
                    ...
                    {this.state.activeStep === 4 ?
                        <RideReview data1={data1} data2={data2} data3={data3} fnc1={this.handleNext} fnc2={this.handleBack} />
                   : null}

                    {this.state.activeStep === 5 ?
                     <RideBilling fnc1={this.handleNext} fnc2={this.handleBack} fnc3={this.handleReset} />
                    : null
                    }
                </form>
...
export default RideShareRegForm;